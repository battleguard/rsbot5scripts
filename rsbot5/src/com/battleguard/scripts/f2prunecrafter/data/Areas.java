...
public enum Areas {
	...
	MIND(new Area(new Tile(2943,3368,0), new Tile(2948,3373,0)),
		new Area(new Tile(2979,3511,0), new Tile(2985,3517,0)),
		new Area(new Tile(2795,4826,0), new Tile(2783,4844,0))),
